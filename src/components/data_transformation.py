...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info(
                f"Saved preprocessing object to path: {preprocessor_obj_file_path}.")
            logging.info(
                f"Data transformation completed. Returing train, test array and preprocessing object path.")
